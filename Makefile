...
TEST_OBJ_LIST = $(TEST_FILES:.cpp=.o)

GTEST_LIB = -lgtest -lgtest_main -pthread

all: runLab1 runTests
...
runTests: $(OBJ_LIST) $(TEST_OBJ_LIST)
	$(COMPILER) $(COMPILER_FLAGS) -o runTests $(OBJ_LIST) $(TEST_OBJ_LIST) $(GTEST_LIB)
	./runTests
...
# Полная очистка
full_clean:
	rm -f $(OBJ_LIST) $(TEST_OBJ_LIST) runLab1 runTests GaussianBlur.bmp Rotated90CounterClockwise.bmp Rotated90Clockwise.bmp

.PHONY: all remove_objs full_clean runTests
